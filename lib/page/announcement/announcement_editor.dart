import 'package:absq/vo/announcement.dart';
...
class _AnnouncementEditorState extends State<AnnouncementEditor> {
  ...
  void initState() {
    ...
    if (widget.announcement != null) {
      ...
      _descCtl.text = _announcement?.desc??"";
    }
  }
  ...
  Widget build(BuildContext context) {
    final descBox = InputText(
      labelTextKey: "announcement.desc",
    ...
    return LocalProgress(
      ...
      child: Scaffold(
        appBar: const LocalAppBar(
          labelKey: "announcement.form.title",
